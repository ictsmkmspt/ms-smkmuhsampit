...
import { X, User as UserIcon, KeyRound, Pencil, Check, Eye, EyeOff } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="field-input text-sm pr-9" required autoComplete="current-password"
                />
                <button
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="field-input text-sm pr-9" required minLength={8}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="field-input text-sm pr-9" required minLength={8} autoComplete="new-password"
                />
                <button
                  type="button" onClick={() => setShowPassword((v) => !v)} tabIndex={-1}
                  title={showPassword ? 'Sembunyikan password' : 'Tampilkan password'}
