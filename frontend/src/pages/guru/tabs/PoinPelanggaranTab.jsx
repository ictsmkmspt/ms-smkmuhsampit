...
const SECTIONS = [
  { key: 'prestasi',    label: 'Poin Prestasi',   icon: Trophy,        component: PoinPrestasiSection },
  { key: 'pelanggaran', label: 'Poin Pelanggaran', icon: AlertTriangle, component: PoinPelanggaranSection },
];
