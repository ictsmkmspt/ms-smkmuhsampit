      ...
      <div className="surface-card p-5">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {assetTersaring.length === 0 && <tr><td colSpan="6" className="py-6 text-center text-ink-300 whitespace-nowrap px-2">{assets.length === 0 ? 'Belum ada data aset.' : 'Tidak ada aset yang cocok dengan pencarian.'}</td></tr>}
          </tbody>
        </table>
        </div>
      </div>
