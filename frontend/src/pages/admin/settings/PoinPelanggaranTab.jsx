    ...
    <div className="space-y-6">
      ...
      <div className="surface-card p-5">
        <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
          ...
          {!showForm && (
            <button onClick={() => { setForm({ name: '', poin: '' }); setError(''); setShowForm(true); }} className="btn-primary shrink-0"><Plus className="w-4 h-4" /> Tambah Jenis Pelanggaran</button>
          )}
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-left text-ink-500 border-b border-line-200">
              ...
              <th className="pb-2 font-medium text-center w-24 whitespace-nowrap px-2">Tipe</th>
          ...
          <tbody>
            ...
            {types.length === 0 && (
              <tr><td colSpan="4" className="py-6 text-center text-ink-300 whitespace-nowrap px-2">Belum ada jenis pelanggaran.</td></tr>
            )}
          </tbody>
        </table>
        </div>
