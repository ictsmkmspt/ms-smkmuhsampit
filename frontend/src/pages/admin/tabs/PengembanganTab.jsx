...
// jadi bagian tetap menu Pembelajaran (Waka Kurikulum); Pemeliharaan sudah
// pindah jadi bagian tetap menu Sarana & Prasarana (Waka Sarpras). Backend
// menu ini juga sudah dibatasi role:admin, bukan cuma disembunyikan di sini.
