    ...
    <div className="space-y-6">
      <div className="surface-card p-4 border-l-4 border-l-brand-400 flex gap-2">
        ...
        <p className="text-sm text-ink-700">
          DUDI = Dunia Usaha/Dunia Industri, yaitu perusahaan/instansi tempat siswa PKL. Setiap DUDI punya akun login sendiri untuk memantau kehadiran dan memverifikasi absensi siswa bimbingannya. Lokasi &amp; radius dipakai untuk memvalidasi absen masuk/pulang siswa lewat GPS.
        </p>
      </div>
      ...
      <div className="surface-card p-5">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {list.length === 0 && (
              <tr><td colSpan="4" className="py-6 text-center text-ink-300">Belum ada DUDI yang terdaftar.</td></tr>
            )}
          </tbody>
        </table>
      </div>
